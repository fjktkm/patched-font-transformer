...
from patched_font_transformer.torchfont.io.font import C_ARGS_LEN
from patched_font_transformer.torchfont.transforms.functional import tensor_to_segment
